...
export type EditorBaseComponentProps = {
  className?: string
...
const EditorBaseComponent: FC<EditorBaseComponentProps> = ({
  ...
  const [contentHeight, setContentHeight] = useState(minHeight - 28)
  ...
  const containerClasses = cn(
    ...
    focused ? 'bg-white border-gray-200' : 'bg-gray-100 border-gray-100 overflow-hidden margin-bottom-4',
  )
