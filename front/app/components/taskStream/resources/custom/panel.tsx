...
import type { CustomResourceNodeType } from './types'
...
const CustomResourcePanel: FC<ResourcePanelProps<CustomResourceNodeType>> = ({
  id,
  data,
}) => {
...
export default React.memo(CustomResourcePanel)
