...
const WebResourceSelector: FC<WebResourceSelectorProps> = ({
  asElement,
  disabled,
  offset = 6,
  onOpenChange,
  ...
  const defaultTriggerElement = (
    <Input
      placeholder={placeholder || '选择Web资源'}
...
export default memo(WebResourceSelector)
