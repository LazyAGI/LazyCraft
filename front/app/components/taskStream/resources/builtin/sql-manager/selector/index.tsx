...
type SqlManagerResourceSelectorProps = {
  asElement?: boolean
  disabled?: boolean
...
const SqlManagerResourceSelector: FC<SqlManagerResourceSelectorProps> = ({
  asElement,
  disabled,
  offset = 6,
  onOpenChange,
  ...
  const filteredResourceList = allResourceList.filter(resourceItem => resourceItem.type === BuiltInResourceEnum.SqlManager)
  ...
  const defaultTriggerElement = (
    <Input
      placeholder={placeholder || '选择SqlManager资源'}
...
export default memo(SqlManagerResourceSelector)
